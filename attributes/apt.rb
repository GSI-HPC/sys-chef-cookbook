...
default_unless[:sys][:apt][:multiarch]     = false
...
default_unless[:sys][:apt][:keys][:add]    = Array.new
default_unless[:sys][:apt][:keys][:remove] = Array.new
default_unless[:sys][:apt][:packages]      = Array.new
